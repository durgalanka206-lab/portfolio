...
import { Users, BookOpen, GraduationCap, Building2, CheckCircle, Clock, LayoutDashboard } from "lucide-react";
      ...
      <div className="flex h-full w-full flex-col">
        ...
        <div className="flex items-center justify-between border-b border-white/5 bg-[#0f141a] px-4 py-2.5">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-semibold tracking-tight text-slate-200 text-xs">EduManage Enterprise</span>
          </div>
              ...
              {[
                ...
                >
                  <div className="mb-2 flex items-center justify-between">
                    <span className="text-[9px] font-medium text-slate-500 uppercase">{widget.label}</span>
            ...
            <div className="flex flex-1 gap-4">
              ...
              <div className="flex-[2] flex flex-col rounded-lg border border-white/5 bg-white/[0.01] p-3 shadow-sm">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <button className="rounded border border-white/10 px-2 py-0.5 text-[9px] text-slate-400 hover:text-slate-200">View All</button>
                </div>
                ...
                <div className="w-full text-left text-[10px]">
                  ...
                  <div className="flex flex-col pt-2">
                    {[
                      { name: "Aarav Kumar", roll: "CS-2024-001", gpa: "3.9", status: "Active", color: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" },
                      { name: "Priya Sharma", roll: "CS-2024-042", gpa: "3.7", status: "Active", color: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" },
                      { name: "Rahul Verma", roll: "ME-2024-018", gpa: "3.4", status: "Warning", color: "bg-amber-500/10 text-amber-400 border-amber-500/20" },
                      { name: "Sophia Patel", roll: "EE-2024-093", gpa: "3.8", status: "Active", color: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" }
                    ].map((student, i) => (
                      <motion.div 
                      ...
                      >
                        ...
                        <div className="col-span-3 text-slate-500 font-mono text-[9px]">{student.roll}</div>
                        <div className="col-span-2 text-slate-400">{student.gpa}</div>
                        <div className="col-span-2">
                          <span className={`inline-flex items-center rounded px-1.5 py-0.5 text-[8px] font-medium border ${student.color}`}>
                            {student.status}
                          </span>
                        </div>
                      </motion.div>
              ...
              <div className="flex-1 rounded-lg border border-white/5 bg-white/[0.01] p-3 shadow-sm flex flex-col">
                ...
                <div className="mt-auto flex h-24 items-end justify-between gap-1">
                  {[65, 78, 85, 92, 88, 96, 94].map((height, i) => (
                    <div key={i} className="group relative w-full rounded-t-sm bg-teal-900/30 hover:bg-teal-800/40">
                      <motion.div 
                        initial={{ height: 0 }}
